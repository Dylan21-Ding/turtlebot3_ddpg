# turtlebot3_ddpg
This code includes the dqn algorithm of the original turnlebot3 and adaptation based on the ddpg of the TORCS game.

The following references are links which contained in the codes downloaded from Turtlebot3 websites.
